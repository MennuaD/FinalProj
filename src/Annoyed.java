...
public class Annoyed extends JFrame implements ActionListener, ItemListener, ChangeListener {
    ...
    public void stateChanged(ChangeEvent e){
        Object source = e.getSource();
        JSlider sliders = (JSlider) source;
        int slideInt = sliders.getValue();
        if (sliders.getValueIsAdjusting()){
            textArea.setText(slideInt + "");
        }
